        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                ...
                                <p style="color:white">Selamat datang di website Pengaduan Masyarakat Desa Sukosari Lor<br>
...
<tr>
<td><h7>NO TELEPON</h7></th><td><input type="text" name="tlp" class="form_input2" required="required"  placeholder="No Telp aktif" maxlength="13" onkeypress="return hanyaAngka(event)"></td>
</tr>
<tr>
